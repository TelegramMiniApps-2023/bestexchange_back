# Generated by Django 4.2.7 on 2024-01-12 02:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_count', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Сколько отдаём')),
                ('out_count', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Сколько получаем')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['valute_from', 'valute_to'], name='no_cash_exc_valute__d074f3_idx')],
