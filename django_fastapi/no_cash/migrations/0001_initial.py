# Generated by Django 4.2.7 on 2023-12-14 02:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period_for_parse_black_list', models.IntegerField(blank=True, default=24, help_text='Значение - положительное целое число.При установлении в 0, останавливает задачу переодического парсинга чёрного списка', null=True, validators=[general_models.utils.model_validators.is_positive_validate], verbose_name='Частота парсинга чёрного списка в часах')),
